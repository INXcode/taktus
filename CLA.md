...
> Beiträge zu Taktus Kontor werden nur nach Annahme dieser Vereinbarung
> aufgenommen. Der Grund steht in [CONTRIBUTING.md](CONTRIBUTING.md): INX Systems
> lizenziert diese Software auf Anfrage auch kommerziell, und das setzt voraus,
> dass die Rechte an allen Bestandteilen in einer Hand liegen.
>
> Grundlage ist die **Fiduciary License Agreement 2.0** der Free Software
> Foundation Europe e.V. Sie ist kein Rechteverzicht: Ziffer 4 verpflichtet uns,
> jeden Beitrag ausschließlich unter Lizenzen weiterzugeben, die die Free
> Software Foundation als freie und die Open Source Initiative als quelloffene
> Lizenzen einstuft. Ziffer 2.3 räumt dir dieselben Rechte an deinem Beitrag
> zurück ein, die du uns einräumst.
>
> Der Text steht im englischen Originalwortlaut. Angepasst sind ausschließlich
> Empfänger, Projektbezug und die Form der Annahme.
...
based on the Individual Contributor Exclusive License Agreement
(including the Traditional Patent License OPTION)

Thank you for your interest in contributing to Taktus Kontor, a project of
INX Systems GmbH ("We" or "Us").

The purpose of this contributor agreement ("Agreement") is to clarify and
document the rights granted by contributors to Us. This Agreement is accepted
electronically: when You open a pull request, an automated assistant will ask
You to confirm that You have read and accept these terms. Your confirmation,
linked to Your account, constitutes acceptance under Section 8.1.
...
employment, You need to have Your employer approve this Agreement. If You do
not own the Copyright in the entire work of authorship, any other author of the
Contribution must also accept this Agreement. In any event, please contact Us
at kontakt@inxsystems.de.
...
WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN DURATION AND
...
governed by the laws of Germany excluding its private international law
provisions.
...
44141 Dortmund
Germany
kontakt@inxsystems.de

---

This Agreement is based on the Fiduciary License Agreement 2.0 by the Free
Software Foundation Europe e.V., written by Matija Šuklje and Catharina
Maracke in collaboration with ContributorAgreements.org, available under
CC BY-SA. Adapted by INX Systems GmbH.
